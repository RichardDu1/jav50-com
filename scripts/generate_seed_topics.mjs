...
const industries = ["AI Video Upscaling", "Video Frame Interpolation AI", "Deepfake & Face Swap Tools", "AI Subtitle Generators", "Video Background Removal"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a Video AI & Media Enhancer Expert for JAV50. Focus on processing speed, resolution outputs, GPU requirements, rendering quality, and ease of use.
